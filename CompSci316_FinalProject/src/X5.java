...
public class X5 {
	...
	public void result( Button gridButtons[][], TextField outputTextField, 
    	...
    	if ( getCounter() <= Math.pow(gridButtons.length, 2)) {
    		...
    		//Down Wins
			end( gridButtons[0][0], gridButtons[0][1], 
				 gridButtons[0][2], gridButtons[0][3], gridButtons[0][4],
    			 outputTextField, player1WinsTextField, player2WinsTextField, 
    			 resetButton, gridButtons, checkButton );
    		end( gridButtons[1][0], gridButtons[1][1], 
    			 gridButtons[1][2], gridButtons[1][3], gridButtons[1][4],
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[2][0], gridButtons[2][1], 
    			 gridButtons[2][2], gridButtons[2][3], gridButtons[2][4],
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[3][0], gridButtons[3][1], 
    			 gridButtons[3][2], gridButtons[3][3], gridButtons[3][4],
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[4][0], gridButtons[4][1], 
       			 gridButtons[4][2], gridButtons[4][3], gridButtons[4][4],
          		 outputTextField, player1WinsTextField, player2WinsTextField, 
          		 resetButton, gridButtons, checkButton );

    		//Across Wins
    		
    		end( gridButtons[0][0], gridButtons[1][0],
    			 gridButtons[2][0], gridButtons[3][0], gridButtons[4][0],
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[0][1], gridButtons[1][1], 
    			 gridButtons[2][1], gridButtons[3][1], gridButtons[4][1],
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[0][2], gridButtons[1][2], 
    			 gridButtons[2][2], gridButtons[3][2], gridButtons[4][2],
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[0][3], gridButtons[1][3], 
    			 gridButtons[2][3], gridButtons[3][3], gridButtons[4][3],
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
       		end( gridButtons[0][4], gridButtons[1][4], 
           		 gridButtons[2][4], gridButtons[3][4], gridButtons[4][4],
              	 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );

    		//Diagonal Wins
    		
    		end( gridButtons[0][0], gridButtons[1][1], 
    			 gridButtons[2][2], gridButtons[3][3], gridButtons[4][4],
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[4][0], gridButtons[3][1], 
    			 gridButtons[2][2], gridButtons[1][3], gridButtons[0][4],
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );

    		//Stamp Wins
    		
    		endShort( gridButtons[0][0], gridButtons[1][0], 
    				  gridButtons[0][1], gridButtons[1][1], 
    				  outputTextField, player1WinsTextField, 
    				  player2WinsTextField, resetButton, 
    				  gridButtons, checkButton );
    		endShort( gridButtons[3][0], gridButtons[4][0], 
    				  gridButtons[3][1], gridButtons[4][1], 
    				  outputTextField, player1WinsTextField, 
    				  player2WinsTextField, resetButton, 
       				  gridButtons, checkButton );
    		endShort( gridButtons[0][3], gridButtons[1][3], 
    			      gridButtons[0][4], gridButtons[1][4], 
    			      outputTextField, player1WinsTextField, 
    			      player2WinsTextField, resetButton, 
    			      gridButtons, checkButton );
    		endShort( gridButtons[3][3], gridButtons[4][3], 
    			      gridButtons[3][4], gridButtons[4][4], 
    			      outputTextField, player1WinsTextField, 
    			      player2WinsTextField, resetButton, 
    			      gridButtons, checkButton );
    		...
    		endShort( gridButtons[0][0], gridButtons[0][4], 
       			      gridButtons[4][0], gridButtons[4][4], 
          			  outputTextField, player1WinsTextField, 
          			  player2WinsTextField, resetButton, 
          			  gridButtons, checkButton );
	...
	//Only for 5-in-a-row
	public void end( Button button1, Button button2, 
    	...
    	done( button1, button2, button3, button4, button5, 
    		  getPlayer1Character(), outputTextField, getPlayer1Counter(), 
    		  player1WinsTextField, resetButton, gridButtons, checkButton);
    	
    	done( button1, button2, button3, button4, button5, 
    		  getPlayer2Character(), outputTextField, getPlayer2Counter(), 
    		  player2WinsTextField, resetButton, gridButtons, checkButton);
    }

	//Method breaks down 'result' method, and allows the game to 
	//etermine which player got a tic-tac-toe.
	//(Simplifies winner into a single method)
	//Only for 4-in-a-row
	public void endShort( Button button1, Button button2, 
			Button button3, Button button4, 
			TextField outputTextField, TextField player1WinsTextField,
			TextField player2WinsTextField, Button resetButton, 
			Button gridButtons[][], boolean checkButton[] ) {

		doneShort( button1, button2, button3, button4, getPlayer1Character(), 
	    		  outputTextField, getPlayer1Counter(), player1WinsTextField, 
	    		  resetButton, gridButtons, checkButton);

		doneShort( button1, button2, button3, button4, getPlayer2Character(), 
	       		  outputTextField, getPlayer2Counter(), player2WinsTextField, 
	       		  resetButton, gridButtons, checkButton );
	}
	
	
	//Method determines the winner of 5-in-a-row
	public void done( Button button1, Button button2, 
					  Button button3, Button button4, Button button5,
		...
		if ( button1.getText() == character && button2.getText() == character && 
			 button3.getText() == character && button4.getText() == character &&
			 button5.getText() == character) {
	...
	//Method determines the winner of 4-in-a-row
	public void doneShort( Button button1, Button button2, 
			Button button3, Button button4,
			String character, TextField output, 
			int playerCounter, TextField playerWins, 
			Button reset, Button gridButtons[][], 
