...
public class X4 {
	...
	public void result( Button gridButtons[][], TextField outputTextField, 
    	...
    	if ( getCounter() <= Math.pow(gridButtons.length, 2)) {
    		...
    		//Down Wins
				 ...
				 gridButtons[0][2], gridButtons[0][3], 
    			 ...
    			 gridButtons[1][2], gridButtons[1][3], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[2][0], gridButtons[2][1], 
    			 gridButtons[2][2], gridButtons[2][3], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[3][0], gridButtons[3][1], 
    			 gridButtons[3][2], gridButtons[3][3], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		...
    		//Across Wins
    			 ...
    			 gridButtons[2][0], gridButtons[3][0], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[0][1], gridButtons[1][1], 
    			 gridButtons[2][1], gridButtons[3][1], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[0][2], gridButtons[1][2], 
    			 gridButtons[2][2], gridButtons[3][2], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[0][3], gridButtons[1][3], 
    			 gridButtons[2][3], gridButtons[3][3], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		...
    		//Diagonal Wins
    			 ...
    			 gridButtons[2][2], gridButtons[3][3], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[3][0], gridButtons[2][1], 
    			 gridButtons[1][2], gridButtons[0][3], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		...
    		//Stamp Wins
    			 ...
    			 gridButtons[0][1], gridButtons[1][1], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[2][0], gridButtons[3][0], 
    		     gridButtons[2][1], gridButtons[3][1], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[0][2], gridButtons[1][2], 
    			 gridButtons[0][3], gridButtons[1][3], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
    		end( gridButtons[2][2], gridButtons[3][2], 
    			 gridButtons[2][3], gridButtons[3][3], 
       			 outputTextField, player1WinsTextField, player2WinsTextField, 
       			 resetButton, gridButtons, checkButton );
	...
	public void end( Button button1, Button button2, 
    	...
    	done( button1, button2, button3, button4, getPlayer1Character(), 
    		  outputTextField, getPlayer1Counter(), player1WinsTextField, 
    		  resetButton, gridButtons, checkButton);
    	
    	done( button1, button2, button3, button4, getPlayer2Character(), 
